...
export const api = {
  ...
  clientCarrierRates: <TResult = unknown>(orgId?: string) => request<TResult>(`/api/operator/client-carrier-rates${orgId ? `?orgId=${encodeURIComponent(orgId)}` : ""}`),
  createClientCarrierRate: <TResult = unknown>(payload: unknown) => request<TResult>("/api/operator/client-carrier-rates", { method: "POST", body: payload }),
  updateClientCarrierRate: <TResult = unknown>(id: string, payload: unknown) => request<TResult>(`/api/operator/client-carrier-rates/${id}`, { method: "PATCH", body: payload }),
  deleteClientCarrierRate: (id: string) => request<void>(`/api/operator/client-carrier-rates/${id}`, { method: "DELETE" }),
  quoteCompare: <TResult = unknown>(payload: unknown) => request<TResult>("/api/operator/quote-compare", { method: "POST", body: payload }),
