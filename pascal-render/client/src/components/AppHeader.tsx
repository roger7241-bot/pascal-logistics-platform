...
const CLIENT_NAV_ITEMS = [
  ...
  { to: "/client-portal/tracking", label: "Shipment Tracking" },
  { to: "/client-portal/counterparties", label: "Carriers & Brokers" },
  { to: "/client-portal/hts", label: "HTS Lookup" },
