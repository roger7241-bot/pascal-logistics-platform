...
export type ActivityEventType = "paps_released" | "rate_savings_captured" | "reroute_triggered" | "executive_decision" | "shipment_ingested" | "shipment_voided" | "spot_quote_viewed";
